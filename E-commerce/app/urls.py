...
from .forms import LoginForm,MyPasswordChangeForm,MyPasswordReserForm,MySetPasswordForm
urlpatterns = [
    path('', views.ProdcutView.as_view(),name= 'home'),
    path('product-detail/<int:pk>', views.ProductDetailView.as_view(), name='product-detail'),
    path('add-to-cart/', views.add_to_cart, name='add-to-cart'),
    path('cart/',views.show_cart,name=views.showcart),
    ...
    form_class=MyPasswordReserForm),name='password_reset'),
    ...
    form_class = MySetPasswordForm),name='password_reset_comfirm'),
    path('password-reset-complete/',auth_views.PasswordResetCompleteView.as_view(template_name = 'app/password_reset_complete'),name='password_reset_complete'),
    path('logout/', auth_views.LogoutView.as_view(next_page = 'login'),name='logout'),
    path('registration/', views.CustomerRegisterationView.as_view(),
